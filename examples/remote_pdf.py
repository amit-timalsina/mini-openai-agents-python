"""
This example shows how to use the OpenAI SDK to upload a remote PDF file and use it as a context for a chat.
"""
...
async def main() -> None:
    """
    Main function to upload the PDF file and use it as a context for a chat.
    """
